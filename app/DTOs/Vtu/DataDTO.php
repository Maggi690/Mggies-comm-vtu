...
class DataDTO {
    public function __construct(
        ...
        public readonly string $phone, public readonly int $planId,
        public readonly float $amount, public readonly string $reference,
        public readonly ?int $apiKeyId = null, public readonly array $meta = [],
    ) {}
    public static function fromArray(array $data, int $userId): self {
        return new self($userId,strtolower($data['network']),$data['phone'],(int)$data['plan_id'],(float)$data['amount'],
